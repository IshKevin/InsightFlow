...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            admin.save()
            self.stdout.write(self.style.SUCCESS('  Created admin user: admin@amalitech.com'))
        ...
        if created:
            ...
            regular_user.save()
            self.stdout.write(self.style.SUCCESS('  Created regular user: user@amalitech.com'))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS('  Created data source: Sales Data CSV'))
        ...
        if created:
            self.stdout.write(self.style.SUCCESS('  Created data source: User Analytics API'))
